                    ...
                    <div className="container-fluid p-lg-5 p-4">
                        <div className="row g-4">
                            <div className="col-12 col-lg-2">
                                ...
                                <NavLink activeStyle={{ fontWeight: "bold" }} className="nav-link text-black border-bottom-design-dashboard me-3" to="/manageAllBookings"><i className="fas fa-tasks me-2"></i>Manage All Bookings</NavLink>
                                <NavLink activeStyle={{ fontWeight: "bold" }} className="nav-link text-black border-bottom-design-dashboard me-3" to="/addNewService"><i className="fas fa-plus me-2"></i>Add New Service</NavLink>
                            </div>
